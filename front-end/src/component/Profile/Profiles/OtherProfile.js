...
function OtherProfile({ username, email, phone, followers, following }) {
  return (
    <div>
    <Navbar />
    <div className="row py-5 px-4">
      <div className="col-md-5 mx-auto">
        <div className="bg-white shadow rounded overflow-hidden">
          ...
          <div className="bg-light d-flex justify-content-end pt-3 pr-3" style={{height:"100px"}}>
          <button type="button" class="btn btn-outline-success " style={{height:"50px", borderRadius:"100px"}}>Follow</button>
           </div>
